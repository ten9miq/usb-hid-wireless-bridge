...
enum class ConfigCommand : int8_t {
    ...
    ADD_QUIRK = 24,
    GET_QUIRK = 25,
    MOUSE_PIPELINE_TRACE_CLEAR = 26,
    MOUSE_PIPELINE_TRACE_ARM = 27,
    MOUSE_PIPELINE_TRACE_MARK = 28,
    MOUSE_PIPELINE_TRACE_FREEZE = 29,
    MOUSE_PIPELINE_TRACE_INFO = 30,
    MOUSE_PIPELINE_TRACE_RECORD = 31,
};
